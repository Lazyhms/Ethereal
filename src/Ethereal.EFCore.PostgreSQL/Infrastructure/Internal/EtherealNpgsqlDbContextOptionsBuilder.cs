...
/// </summary>
public abstract class EtherealNpgsqlDbContextOptionsBuilder<TBuilder, TExtension> : IRelationalDbContextOptionsBuilderInfrastructure
                                                                   where TBuilder : EtherealNpgsqlDbContextOptionsBuilder<TBuilder, TExtension>
                                                                   where TExtension : class, IDbContextOptionsExtension, new()
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EtherealNpgsqlDbContextOptionsBuilder{TBuilder, TExtension}"/> class.
    /// </summary>
    /// <param name="optionsBuilder">The core options builder.</param>
    public EtherealNpgsqlDbContextOptionsBuilder(DbContextOptionsBuilder optionsBuilder) => OptionsBuilder = optionsBuilder;
